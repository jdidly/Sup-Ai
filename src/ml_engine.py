...
class MLEngine:
    ...
    def extract_features(self, psc_price, ton_price, ratio, additional_features=None):
        ...
        try:
            ...
            if ratio > 1.0:
                momentum_score = min(ratio / 4.0, 1.0)  # Capped momentum
            else:
                momentum_score = ratio  # Weak momentum
    ...
    def _ml_prediction(self, features, psc_price, ton_price, ratio, amount):
        ...
        try:
            ...
            if timer_minute < 3 and ratio > 1.5 and small_move_prob > 0.5:  # Entry + good ratio + small move
            ...
            # Adjust expected return based on PSC system characteristics
            if ratio > 2.5:  # Strong PSC signal
                expected_return *= 1.2
            elif ratio > 2.0:  # Good PSC signal
                expected_return *= 1.1
            elif ratio < 1.5:  # Weak signal
                expected_return *= 0.8
            ...
            return {
                ...
                'ratio_strength': ratio / 3.5,  # Normalized ratio strength
    ...
    def _store_ml_signal_json_fallback(self, signal_data):
        ...
        try:
            ml_signals_dir = Path("data/ml_signals")
